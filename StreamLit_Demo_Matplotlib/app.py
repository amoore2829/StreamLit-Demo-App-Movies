...
with st.expander("Raw Dataset https://www.kaggle.com/datasets/ursmaheshj/top-10000-popular-movies-tmdb-05-2023?resource=download"):
    @st.cache_data
    def load_data():
...
genre_filter = st.sidebar.selectbox('Select Genre', unique_genres)
